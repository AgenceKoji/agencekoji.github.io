<template>
  <footer class="bg-white dark:bg-gray-900 border-t border-slate-200 drop-shadow-2xl mt-12">
...
const navigation = [
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/agencekoji/',
    icon: defineComponent({
      render: () =>
        h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
          h('path', {
